...
#include "AvaliacaoGameInstance.h"
...
UAvaliacaoGameInstance::UAvaliacaoGameInstance(const FObjectInitializer& ObjectInitializer)
{
	/*
...
void UAvaliacaoGameInstance::Join(const FString& Address)
{
...
void UAvaliacaoGameInstance::LoadMenu()
{
